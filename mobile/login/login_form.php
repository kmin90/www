...
<form name="member_form" method="post" action="login.php"> 
    ...
    <div id="id_pw_input">
        ...
        <ul>
            <li>
                <input type="text" name="id" class="login_input" autocomplete="off"
              placeholder="아이디 입력" required ></li>
            <li>
                <input type="password" name="pass" class="login_input" autocomplete="off"
              placeholder="비밀번호 입력" required></li>
        </ul>						
	</div>
    <div id="login_button">
