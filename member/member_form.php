     ...
     <table>
      <caption class="hidden">회원가입</caption>
     	...
     	<tr>
     		...
     		<td>
     			 <input type="password" name="pass" id="pass" maxlength="8" placeholder="8자 이내" required>
     		</td>
     	</tr>
     	<tr>
     		<th scope="col"><label for="pass_confirm">비밀번호확인</label></th>
     		<td>
     			<input type="password" name="pass_confirm" id="pass_confirm" maxlength="8" required>
     	...
     	<tr>
     		...
     		<td>
     			 <input type="text" name="nick" id="nick" maxlength="10" placeholder="10자 이내" required>
